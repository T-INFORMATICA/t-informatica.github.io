...
<html>
  ...
  <!-- HOME BUTTON -->
  <a href="/_t-inf-lms/"><span class="material-icons">home</span></a>
  <!-- COURSE DROPDOWN -->
      ...
      <div class="courseNav">
        <h1><a href="/_t-inf-lms/courses/webontwikkeling/">webontwikkeling</a></h1>
          ...
          <div class="subjectNav">
            ...
            <a href="/_t-inf-lms/courses/webontwikkeling/layout/inleiding.html">Inleiding</a>
          ...
          <div class="subjectNav">
            ...
            <a href="/_t-inf-lms/courses/webontwikkeling/dynamische-websites/sql-database-connection.html">SQL Database Connection</a>
  ...
  <!-- PROFILE DROPDOWN -->
  <span class="dropdownButton profileButton">
    <span class="material-icons">
      person
    </span>
    <div class="small dropdown">
      <ul>
        <li><a href="/_t-inf-lms/?show=puntenboek">Rapport</a></li>
        <li><a href="/_t-inf-lms/?show=evaluaties">Evaluaties</a></li>
        <hr>
        <li><a href="/_t-inf-lms/?show=profiel">Profiel</a></li>
      </ul>
    </div>
  </span>
  <!-- EXERCISE BUTTON -->
  <a href="/_t-inf-lms/exercise.html" class="exerciseButton"><span class="material-icons">assignment</span></a>
  <!-- SEARCH BUTTON -->
...
<section id="profileContent">
    <a href="#studentNavigation" class="material-icons">menu</a>
